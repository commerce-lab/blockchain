...
public class RedisUtil {
    ...
    private void initJedisPool() {
        ...
        String url = PropertiesUtil.getPropertiesVal("common.properties", "redis.host-name");
        String port = PropertiesUtil.getPropertiesVal("common.properties", "redis.port");
        Integer portInt = Integer.valueOf(port);
        
        jedisPool = new JedisPool(config,url, portInt);
    }
