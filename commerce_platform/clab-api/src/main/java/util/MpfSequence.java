 ...
 * @date 2016-08-18
 */
public class MpfSequence {

    private static final Log logger = LogFactory.getLog(MpfSequence.class);
    ...
    public MpfSequence(long workerIdBits,long datacenterIdBits,long sequenceBits) {
     ...
     */
    public MpfSequence(long workerId, long datacenterId) {
