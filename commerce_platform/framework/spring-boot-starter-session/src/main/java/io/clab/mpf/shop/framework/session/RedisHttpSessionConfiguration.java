...
public class RedisHttpSessionConfiguration extends SpringHttpSessionConfiguration
	...
	private String database="*"; //默认为所有DB
	...
	public RedisMessageListenerContainer redisMessageListenerContainer(
		...
		container.addMessageListener(messageListener,
				Arrays.asList(new PatternTopic("__keyevent@"+this.database+":del"),
						new PatternTopic("__keyevent@"+this.database+":expired")));
	...
	public RedisOperationsSessionRepository sessionRepository(
			@Qualifier("redisTemplate") RedisOperations<Object, Object> sessionRedisTemplate,
	...
	public void setImportMetadata(AnnotationMetadata importMetadata) {
		...
		Map<String, Object> enableAttrMap = importMetadata
				.getAnnotationAttributes(EnableMpfRedisSession.class.getName());
		AnnotationAttributes enableAttrs = AnnotationAttributes.fromMap(enableAttrMap);
		this.maxInactiveIntervalInSeconds = enableAttrs
				.getNumber("maxInactiveIntervalInSeconds");
		this.database = enableAttrs.getNumber("database")+"__";
